    ...
    class SignUp {
        ...
        void 회원가입() {
            ...
            Mockito.when(userRepository.findByEmail(signupRequestDto.getEmail()))
                    .thenReturn(Optional.empty());
            //when
            boolean result = userService.registerUser(signupRequestDto.getEmail(), signupRequestDto.getPassword(), signupRequestDto.getUsername());
            //then
            assertThat(result).isEqualTo(true);
        }
        ...
        class SignUpFail {
            ...
            class DupError {
                ...
                void 이메일중복() {
                    ...
                    //when
                    //then
                    assertThrows(DuplicateUserException.class, () -> userService.registerUser(signupRequestDto.getEmail(), signupRequestDto.getPassword(), signupRequestDto.getUsername()), "이메일이 중복되었습니다.");
                }
            }
            ...
            class SignUpFail2 {
                ...
                void 이메일형식불량1() {
                    ...
                    //when
                    //then
                    assertThrows(EmailFormException.class, () -> userService.registerUser(signupRequestDto.getEmail(), signupRequestDto.getPassword(), signupRequestDto.getUsername()), "이메일 형식으로 입력해주세요.");
                }
            ...
            class PasswordError {
                ...
                void 비밀번호길이불량1() {
                    ...
                    //when
                    //then
                    assertThrows(LengthException.class, () -> userService.registerUser(signupRequestDto.getEmail(), signupRequestDto.getPassword(), signupRequestDto.getUsername()), "비밀번호 8~16자리의 영문과 숫자를 조합해주세요.");
                }
            ...
            class BlankError {
                ...
                void 이메일blank() {
                    ...
                    //when
                    //then
                    assertThrows(EmptyException.class, () -> userService.registerUser(signupRequestDto.getEmail(), signupRequestDto.getPassword(), signupRequestDto.getUsername()), "모든 내용을 입력해주세요.");
                }
